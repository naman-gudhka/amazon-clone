...
export class Product{
  ...
  constructor(productDetails){
    ...
    this.keywords = productDetails,this.keywords;
  }
...
// 'fun' here is a callback function that will be called after the products are loaded. This allows us to perform some actions (like rendering the products grid) after the products are available.
